...
path_ensembl=/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag/RetroFunRVS/pathways/biomart_syngo_genes_pos.txt
...
cut -f 7 /lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag/RetroFunRVS/pathways/syngo_ontologies.txt | sed "s/, /\n/g" | sort | uniq > ${path_pathways}/syngo_ontologies_all_genes_symbols.txt
...
cut -f7 /lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag/RetroFunRVS/pathways/syngo_ontologies.txt | while IFS= read -r line
do

...
ln -s /lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag/RetroFunRVS/genes/EnhancerPredictions_NEU_iPSC_liftoverhg38.txt ${path_exons}/EnhancerPredictions_NEU_iPSC_liftoverhg38.txt
...
If the with_mask version of this code was run already, use 
ln -s /lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag/RetroFunRVS/genes/* ${path_exons}/
...
do
  ...
  do
    ...
    do
      ...
      cat <(grep "$field2" <(echo "$file_chr")) <(echo "$line") >> ${path_rvs}/objets_ped/check_CRH_membership.txt
    done < <(tail -n +2 $file)
  done
  #Overlap 0 TAD
  ...
  do
    ...
    do
      ...
      cat <(grep "$field2" <(echo "$file_chr")) <(paste <(echo "$line")) >> ${path_rvs}/objets_ped/check_CRH_membership.txt
...
#ln -s /lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag/RetroFunRVS/TADs/with_exons/CRHs_by_TADs.txt ${path_rvs}/TADs/with_exons/CRHs_by_TADs.txt
mkdir ${path_rvs}/TADs/with_exons
R
path_impu <- "/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs"
membership_equi <- data.table::fread("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/objets_ped/CRH_problem_membership_equivalence.txt")
...
data.table::fwrite(CRHs_by_TADs, "/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/with_exons/CRHs_by_TADs.txt", row.names = FALSE, col.names = TRUE, sep = "\t")
quit()
n
...
Rscript /lustre03/project/6033529/quebec_10x/scripts/WGS_bs_2022_500samples_without_mask/call/2025-02-17_CRH_empty_gene_border.R
#Affected TADs: ${path_rvs}/TADs/with_exons/CRH_affecting_TAD_by_gene_addition.txt
for chr in {1..22}
do
...
R
for (chr in 1:22){
  CRH_files <- list.files(paste0("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/with_exons/TADs_for_CRHs_overlap_1_TAD/chr", chr))
  CRH_files <- CRH_files[!grepl("_backup", CRH_files, fixed = TRUE)]
  overlap <- data.frame()
  for (file in CRH_files){
    CRH_og <- data.table::fread(paste0("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/with_exons/TADs_for_CRHs_overlap_1_TAD/chr", chr, "/", file))
    ...
    system(paste0("mv /lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/with_exons/TADs_for_CRHs_overlap_1_TAD/chr", chr, "/", file, " /lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/with_exons/TADs_for_CRHs_overlap_1_TAD/chr", chr, "/", file, "_overlap"))
    data.table::fwrite(data.table::as.data.table(CRH), paste0("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/with_exons/TADs_for_CRHs_overlap_1_TAD/chr", chr, "/", file), col.names = FALSE, row.names = FALSE, sep = "\t")
  }
  data.table::fwrite(data.table::as.data.table(overlap), paste0("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/with_exons/TADs_for_CRHs_overlap_1_TAD/chr", chr, "/overlaps.txt"), col.names = FALSE, row.names = FALSE, sep = "\t")
}
quit()
n
...
#RESTE A ADAPTER A CAS SANS MASQUE:
#---- CHRs - Overlap 0 TAD ----
...
do
  ...
  CRH_equi=$(awk -v CRH="$CRH" '$2 == CRH' ${path_rvs}/objets_ped/CRH_problem_membership_equivalence.txt | cut -f1)
...
#There might be cases where some intervals in the .bed overlap.
R
CRH_files <- list.files("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_0/with_exons")
CRH_files <- CRH_files[grepl(".txt", CRH_files, fixed = TRUE)]
overlap <- data.frame()
for (file in CRH_files){
  CRH_og <- data.table::fread(paste0("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_0/with_exons/", file))
  CRH <- data.frame(CRH_og)
  overlap_CRH <- 0
  if(nrow(CRH)>1){
    for (i in 2:nrow(CRH)){
  ...
  system(paste0("mv /lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_0/with_exons/", file, " /lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_0/with_exons/", file, "_overlap"))
  data.table::fwrite(data.table::as.data.table(CRH), paste0("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_0/with_exons/", file), col.names = FALSE, row.names = FALSE, sep = "\t")
}
data.table::fwrite(data.table::as.data.table(overlap), paste0("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_0/with_exons/overlaps.txt"), col.names = FALSE, row.names = FALSE, sep = "\t")
quit()
n
...
#There might be cases where some intervals in the .bed overlap.
R
CRH_files <- list.files("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_2/with_exons")
CRH_files <- CRH_files[grepl(".txt", CRH_files, fixed = TRUE)]
overlap <- data.frame()
for (file in CRH_files){
  CRH_og <- data.table::fread(paste0("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_2/with_exons/", file))
  CRH <- data.frame(CRH_og)
  overlap_CRH <- 0
  if(nrow(CRH)>1){
    for (i in 2:nrow(CRH)){
  ...
  CRH <- CRH[!is.na(CRH[[2]]),]
  overlap <- rbind(overlap, data.frame("CRH_file" = file, "overlap" = overlap_CRH))
  system(paste0("mv /lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_2/with_exons/", file, " /lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_2/with_exons/", file, "_overlap"))
  data.table::fwrite(data.table::as.data.table(CRH), paste0("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_2/with_exons/", file), col.names = FALSE, row.names = FALSE, sep = "\t")
}
data.table::fwrite(data.table::as.data.table(overlap), paste0("/lustre03/project/6033529/quebec_10x/data/WGS_bs_2022/500_samples_cag_without_mask/RetroFunRVS/TADs/overlap_2/with_exons/overlaps.txt"), col.names = FALSE, row.names = FALSE, sep = "\t")
quit()
n
